...
2. Run `ant` to compile Basic Statistics. The compiled class files will be in the *bin* directory.
...
2. Run: `java -cp . BasicStats`. The application's GUI will show up.
